...
# : ${DATA_DIR:=${1:-"/users/agoksoy/Desktop/Eagle/training/rnn_speech_recognition/pytorch/dataset/LibriSpeech"}}
: ${DATA_DIR:=${1:-"/datasets/LibriSpeech"}}
: ${MODEL_CONFIG:=${2:-"configs/baseline_v3-1023sp_gpu.yaml"}}
