...
# from warp_rnnt import rnnt_loss as WarpRNNTLoss
...
class RNNTLoss(torch.nn.Module):
    ...
    def forward(self, logits, logit_lens, y, y_lens):
        ...
        # loss = WarpRNNTLoss(
        #     log_probs=logits, labels=y, frames_lengths=logit_lens, labels_lengths=y_lens, blank=self.blank
        # )
