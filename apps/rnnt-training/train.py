...
from rnnt import config_gpu as config
from rnnt.decoder import RNNTGreedyDecoder
from rnnt.loss_gpu import RNNTLoss
...
def main():
    ...
    print("Epochs: " + str(args.epochs) + " Steps For Grad Accumulation in epoch: " + str(args.grad_accumulation_steps) + " Batch Size: " + str(batch_size))
