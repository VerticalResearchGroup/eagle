...
def get_args():
    ...
    parser.add_argument("--log_file",
                        default="/u/c/s/cs838-1/public/kits19/inferdata/build/logs/mlperf_log_accuracy.json",
    ...
    parser.add_argument("--preprocessed_data_dir",
                        default="/u/c/s/cs838-1/public/kits19/inferdata/build/preprocessed_data",
                        help="Path to the directory containing preprocessed data")
    parser.add_argument("--postprocessed_data_dir",
                        default="/u/c/s/cs838-1/public/kits19/inferdata/build/postprocessed_data",
