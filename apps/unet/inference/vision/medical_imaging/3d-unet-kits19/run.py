...
def get_args():
    ...
    parser.add_argument("--mlperf_conf",
                        default="/u/c/s/cs838-1/public/kits19/inferdata/build/mlperf.conf", #edit
                        help="mlperf rules config")
    parser.add_argument("--user_conf",
                        default="user.conf",
                        help="user config for user LoadGen settings such as target QPS")
    parser.add_argument("--model",
                        default="/u/c/s/cs838-1/public/kits19/inferdata/build/model/3dunet_kits19_pytorch.ptc", #edit
                        help="Path to PyTorch, ONNX, or TF model")
    parser.add_argument("--preprocessed_data_dir",
                        default="/u/c/s/cs838-1/public/kits19/inferdata/build/preprocessed_data", #edit
...
def main():
    ...
    log_path = Path("/u/c/s/cs838-1/public/kits19/inferdata/build", "logs").absolute()
