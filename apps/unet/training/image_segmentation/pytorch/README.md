# Using Bash scripts to setup and run training - 
unet_setup_download_raw_data.sh [dir where you want your data to be downloaded]

unet_preprocess_training_data.sh [Absolute dir name as provided by above .sh script] [dir name where you want your pre-processed data]

unet_run_training.sh [dir where pre-processed data is residing]



# Otherwise go through below steps as mention in original ML-Perf docs
