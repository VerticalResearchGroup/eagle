...
class Preprocessor:
    ...
    def preprocess_dataset(self):
        # os.makedirs(self.results_dir, exist_ok=True) #edit
...
if __name__ == '__main__':
    ...
    PARSER.add_argument('--raw_data_dir', dest='data_dir', required = True) #edit
    PARSER.add_argument('--preprocessed_data_dir', dest='results_dir', required = True) #edit
    PARSER.add_argument('--mode', dest='mode', choices=["preprocess", "verify"], default="preprocess") #edit
